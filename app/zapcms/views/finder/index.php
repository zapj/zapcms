<div class="row mb-3">
    <div class="col-sm-5">
        <a href="<?php echo $parent_url;?>" id="btn-parent" data-bs-toggle="tooltip" title="上一级" class="btn btn-light"><i class="fa-solid fa-level-up-alt"></i></a>
        <a href="<?php echo $current_url;?>" id="btn-refresh" data-bs-toggle="tooltip" title="刷新" class="btn btn-light"><i class="fa-solid fa-rotate"></i></a>
...
<hr>
<div class="row row-cols-sm-3 row-cols-lg-4 zapFinderFileList" >
...
<script>
    $('#btn-refresh').on('click',function(event){
        ...
        $('.zapFinderFileList').load($(this).attr('href'));
    })
</script>