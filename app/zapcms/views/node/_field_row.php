    ...
    <div class="field-row-body p-3">
        <div class="row g-2 align-items-end mb-2">
            <div class="col-md-3">
                ...
                <input type="text" class="form-control form-control-sm field-name"
                       name="field[<?=$i?>][field_name]" value="<?=e($f['field_name'] ?? '')?>"
                       placeholder="如 price" pattern="[a-z][a-z0-9_]*" required>
            </div>
            <div class="col-md-3">
                <label class="form-label small mb-1">显示名称</label>
                <input type="text" class="form-control form-control-sm"
                       name="field[<?=$i?>][field_label]" value="<?=e($f['field_label'] ?? '')?>"
                       placeholder="如 产品价格">
            </div>
            <div class="col-md-2">
                <label class="form-label small mb-1">控件类型</label>
                <select class="form-select form-select-sm field-type" name="field[<?=$i?>][type]">
            ...
            <div class="col-md-1">
                ...
                <input type="number" class="form-control form-control-sm"
                       name="field[<?=$i?>][sort_order]" value="<?=(int)($f['sort_order'] ?? 0)?>" min="0">
            </div>
            <div class="col-md-2">
                <label class="form-label small mb-1">是否必填</label>
                <select class="form-select form-select-sm" name="field[<?=$i?>][required]">
        ...
        <div class="row g-2 mb-2">
            <div class="col-md-12">
                ...
                <input type="text" class="form-control form-control-sm"
                       name="field[<?=$i?>][placeholder]" value="<?=e($f['placeholder'] ?? '')?>"
        ...
        <div class="row g-2">
            <div class="col-md-12">
                ...
                <input type="text" class="form-control form-control-sm"
                       name="field[<?=$i?>][help]" value="<?=e($f['help'] ?? '')?>"
