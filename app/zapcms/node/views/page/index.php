            ...
            <div class="card card-outline card-success">
                <div class="card-header p-2">
                    <h6 class="card-title mb-0">
                        <i class="fa fa-sitemap me-1 text-success"></i>栏目导航
                    </h6>
                    <div class="card-tools">
                        <a href="<?php echo Url::action("Node"); ?>"
                           class="btn btn-tool <?php echo !$catalogId ? 'text-success' : ''; ?>" title="全部内容">
            ...
            <div class="card card-outline card-success">
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-2">
                        ...
                        <div class="d-flex align-items-center me-auto">
                            ...
                            <?php if (!empty($catalogPaths)): ?>
                                ...
                                ?>
                            <?php else: ?>
                                <span class="text-muted">全部页面</span>
                            <?php endif; ?>
                        </div>
                        ...
                        <a href="<?php echo Url::action("Node@{$_controller}/add", ['cid' => $catalogId]); ?>"
                           class="btn btn-success btn-sm">
                            <i class="fa fa-plus me-1"></i>添加页面
                        </a>
                    </div>
                </div>
                <!-- /工具栏 -->
                ...
                <div class="card-body p-0">
                    ...
                    <div class="text-center py-5">
                        <i class="fa fa-file-alt fa-3x text-muted mb-3 d-block"></i>
                        <p class="text-muted mb-3">暂无页面数据</p>
                        <a href="<?php echo Url::action("Node@{$_controller}/add", ['cid' => $catalogId]); ?>"
                           class="btn btn-success btn-sm">
                            <i class="fa fa-plus me-1"></i>添加第一个页面
                        </a>
                    </div>
                    <?php endif; ?>
                </div>
