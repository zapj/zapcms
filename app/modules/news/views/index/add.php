...
<main class="container">
    ...
    <div class="my-3 p-3 bg-body rounded shadow-sm">
        <div>
            <a class="btn btn-primary btn-sm" href="<?php echo url_action('Content');?>">内容管理</a>
            <a class="btn btn-primary btn-sm" href="<?php echo url_action('Content@news');?>">返回</a>
        ...
        <div>
            ...
            <div class="text-center" >
                <a class="btn btn-dark" href="<?php echo url_action('Content@news');?>">取消</a>
