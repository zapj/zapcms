 ...
 * Generated at: 2026-08-09 11:37:04
 *
...
class CreateBaseData
{
    public static function install()
    {
        ...
        Schema::table('admin',function (AlertTable $table){
            ...
            $table->batchInert([
                ['1', 'admin', '$2y$10$owYA8LHZU.C3QxaT1XFoBeaJ8WZzHaliAxms3DQ1aLijGQN7pHpie', 'admin', '', 'zapcms-demo@zap.cn', '', '127.0.0.1', '1786246568', 'activated', '1786246619', '1693297157'],
            ]);
        });
        ...
        Schema::table('admin_menu',function (AlertTable $table){
            ...
            $table->batchInert([
                ...
                ['9', '插件', '0', '9,', '1', 'fa-solid fa-puzzle-piece', 'Plugin', '_self', 'action', '(plugin[/.]?.*)', '1', '5', '1786095132', '1786074715'],
                ['10', '系统更新', '3', '3,10,', '2', 'fa-solid fa-arrows-rotate', 'Update', '_self', 'action', '(update[/.]?.*)', '1,2', '3', '1786095104', '1786074715'],
        ...
        Schema::table('node',function (AlertTable $table){
            ...
            $table->batchInert([
                ...
                ['36', '1', 'product', 'iPhone 15', 'iphone-15', '', '<p>iPhone 15</p><p>iPhone 15</p><p>iPhone 15</p><p>iPhone 15</p><p>iPhone 15<br></p>', '', '', '/storage/images/84d9ee44e457ddef7f2c4f25dc8fa865.jpg', '18', '0', '', '0', '', 'publish', '1698495012', '1699519805', '1698495036'],
