...
class CreateBaseData
{
    public static function install()
    {
        ...
        Schema::table('admin',function (AlertTable $table){
            ...
            $table->batchInert([
                ['1', 'admin', '$2y$10$Myocy3mQjR1vkBsTrGVQluspKLKA5lqww68Fgg70K5fuZz6obm24K', 'admin', '', 'zapcms-demo@zap.cn', '', '127.0.0.1', '1702302665', 'activated', '1698205141', '1693297157'],
            ]);
        });

        // Table `admin_logs` — no data
