...
(1, 'admin', '$2y$10$NFxxIy8cV6MEjIqRYsihGuo5ZQwpVDMm43QfKdMMSI3f3wFrBA9oK', 'admin', '051288885373', '83390286@qq.com', NULL, '127.0.0.1', 1702302665, 'activated', 1698205141, 1693297157),
...
(42, 1, 'article', '华为申请“遥遥领先”商标！新品发布会曾被“遥遥领先”刷屏', '华为申请遥遥领先商标新品发布会曾被遥遥领先刷屏', NULL, '<div class=\"qnt-p\" style=\"margin: 0px 0px 30px; line-height: 30px; overflow-wrap: break-word; word-break: break-all;\" pingfang=\"\" sc\",=\"\" \"microsoft=\"\" yahei\",=\"\" avenir,=\"\" \"segoe=\"\" ui\",=\"\" \"hiragino=\"\" sans=\"\" gb\",=\"\" stheiti,=\"\" serif\",=\"\" \"wenquanyi=\"\" micro=\"\" hei\",=\"\" sans-serif;\"=\"\">近期，因华为Mate60系列手机发售，“遥遥领先”成为网络热词。<br><span style=\"background-color: var(--bs-card-bg); font-size: var(--bs-body-font-size); font-weight: var(--bs-body-font-weight); text-align: var(--bs-body-text-align);\">据企查查数据显示，近日，华为技术有限公司申请注册“遥遥领先”商标，国际分类为运输工具、科学仪器，当前商标状态为等待实质审查。<br><div style=\"text-align: start;\"><span style=\"background-color: var(--bs-card-bg); font-size: var(--bs-body-font-size); font-weight: var(--bs-body-font-weight); text-align: justify;\">近期，因华为Mate60系列手机发售，“遥遥领先”成为网络热词。<br></span><span style=\"text-align: justify; background-color: var(--bs-card-bg); font-size: var(--bs-body-font-size); font-weight: var(--bs-body-font-weight);\">据企查查数据显示，近日，华为技术有限公司申请注册“遥遥领先”商标，国际分类为运输工具、科学仪器，当前商标状态为等待实质审查。</span></div><div style=\"text-align: start;\"><span style=\"text-align: justify; background-color: var(--bs-card-bg); font-size: var(--bs-body-font-size); font-weight: var(--bs-body-font-weight);\"><br></span></div></span></div>', '', '', '/storage/images/02522a2b2726fb0a03bb19f2d8d9524d.jpg', 25, 0, NULL, NULL, NULL, 'publish', 1698650814, 1701053124, 1698650832),
